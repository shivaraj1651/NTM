...
async def db_session():
    ...
    async with engine.begin() as conn:
        await conn.run_sync(BaseKPI.metadata.create_all)
        await conn.run_sync(BasePerformanceMetric.metadata.create_all)
        await conn.run_sync(BaseActivation.metadata.create_all)
